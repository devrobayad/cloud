          ...
          {solutionsList.map((item) => {
            return (
              <div 
                ...
                className="group flex flex-col bg-[#ffffff] rounded-2xl overflow-hidden shadow-md hover:shadow-xl border border-slate-100 transition-all duration-300 transform hover:-translate-y-1 cursor-pointer"
              >
                {/* Image Section */}
